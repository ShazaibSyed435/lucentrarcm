...
export default function QualityServices() {
  ...
  return (
    <section className="w-full overflow-hidden bg-[#063c39] py-16 sm:py-20 lg:py-24">
      <Container className="px-5 sm:px-8 lg:px-10">
        ...
        <div className="mx-auto flex max-w-[700px] flex-col items-center text-center">
          ...
          {/* Heading */}
          <h2 className="text-[30px] font-semibold leading-[1.15] tracking-[-0.8px] text-white sm:text-[38px] md:text-[42px] lg:text-[44px]">
            Committed to <span className="text-[#ff6845]">Excellence</span> in
            <br className="hidden sm:block" /> Revenue Cycle Management
          </h2>

          {/* Description */}
          <p className="mt-5 max-w-[650px] text-[13px] leading-[1.8] text-white/60 sm:text-[14px]">
        ...
        <div className="mt-10 overflow-x-auto pb-2 scrollbar-hide">
          <div className="mx-auto flex w-max min-w-full justify-start gap-2 sm:justify-center">
            {services.map((service) => {
              ...
              return (
                <div className={`  border-b-3 border-[#ff6845] ${
                  ...
                  <button
                    ...
                    className={`flex h-[36px] shrink-0 items-center gap-2 rounded-full border px-5 text-[12px] font-medium capitalize transition-all duration-200 ${
                      isActive
        ...
        {activeService && (
          <div className="mx-auto mt-10 max-w-[1150px] overflow-hidden rounded-[14px] bg-white">
            <div className="flex flex-col lg:flex-row">
              ...
              {/* Content */}
              <div className="flex w-full flex-col justify-center p-7 sm:p-9 lg:w-1/2 lg:p-10">
                {/* Badge */}
                <div className="mb-3 flex items-center gap-2">
                  <BriefcaseBusiness className="h-[12px] w-[12px] text-[#ff6845]" />

                  <span className="text-[10px] font-semibold uppercase tracking-[1px] text-[#ff6845]">
                    {activeService.badge}
                  </span>
                </div>

                {/* Heading */}
                <h3 className="text-[25px] font-semibold leading-[1.2] tracking-[-0.5px] text-[#171717] sm:text-[28px]">
                  {activeService.heading}
                </h3>

                {/* Description */}
                <p className="mt-4 max-w-[580px] text-[13px] leading-[1.75] text-[#7a7a7a] sm:text-[14px]">
                ...
                <div className="mt-5 flex flex-col gap-3">
                  {activeService.list.map((item) => (
                    <div key={item} className="flex items-center gap-3">
                      ...
                      <span className="text-[12px] font-medium text-[#202020] sm:text-[13px]">
                        {item}
                      </span>
                    </div>
                  ))}
                ...
                <div className="mt-7">
                  <button
                    type="button"
                    className="h-[38px] rounded-full bg-[#075f5b] px-7 text-[12px] font-semibold text-white transition hover:bg-[#064d49]"
                  >
