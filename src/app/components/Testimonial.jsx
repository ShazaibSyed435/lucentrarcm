    ...
    >
      <Container className="px-5 sm:px-8 lg:px-10">
        ...
        <div className="mx-auto flex max-w-[760px] flex-col items-center text-center">
          ...
          {/* Heading */}
          <h2 className="text-[30px] font-semibold leading-[1.15] tracking-[-1px] text-[#102b2a] sm:text-[38px] md:text-[42px] lg:text-[44px]">
            What Our <span className="text-[#075f5b]">Clients Say</span>
          </h2>

          {/* Description */}
          <p className="mt-5 max-w-[680px] text-[14px] leading-[1.8] text-[#7b8585] sm:text-[15px]">
        ...
        <div className="relative mt-12">
          ...
          <div className="overflow-hidden">
            ...
            >
              {extendedTestimonials.map((testimonial, index) => (
                ...
                >
                  <div className="relative flex h-full  flex-col rounded-[14px] bg-white p-6 shadow-[0_8px_25px_rgba(7,95,91,0.06)] sm:p-7">
                    ...
                    {/* Stars */}
                    <div className="flex gap-1 text-[20px] leading-none text-[#ef7548]">
                      ★★★★★
                    </div>

                    {/* Testimonial */}
                    <p className="mt-5 text-[13px] leading-[1.8] text-[#777f80] sm:text-[14px]">
                      &quot;{testimonial.text}&quot;
                    </p>
          ...
          <div className="mt-7 flex items-center justify-center gap-8">
            <button
              ...
              className="flex h-8 w-8 items-center justify-center text-[#172b2b] transition hover:text-[#ff6845]"
